...
class UpdateRecordView(mixins.LoggedInOnlyView, SuccessMessageMixin, UpdateView):
    model = models.User
    template_name = "users/update-record.html"
    fields = (
        "pacer",
        "longTimeRun",
        "stepTest",
    ...
    def get_form(self, form_class=None):
        ...
        # form.fields["pushUp"].widget.attrs = {"placeholder": "Push up"}
        form.fields["sitUp"].widget.attrs = {"placeholder": "Sit up"}
        form.fields["grip"].widget.attrs = {"placeholder": "Grip"}
        form.fields["sprint"].widget.attrs = {"placeholder": "Sprint"}
        form.fields["longJump"].widget.attrs = {"placeholder": "Longjump"}
        form.fields["height"].widget.attrs = {"placeholder": "Height"}
